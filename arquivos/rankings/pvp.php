...
<div class="top-content"><span style="padding:0 200px;" class="title-page">TOP 50 PVP</span></div>
<div class="middle-content">

<div class="text-content">
<span class="title-text" style="font-family:'trajan Pro'; font-size:14px;">TOP PVP LIST</span></br></br>
...
$top = mysql_query("SELECT * FROM characters where $accesslevel=0 ORDER BY $pvp DESC LIMIT 0, ".$limite."");
$fixo = 1;
