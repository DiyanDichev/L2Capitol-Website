...
<title><?php print SERVER_NAME; ?>- Unlock Char</title>
...
<body>
<div id="menu_holder"><div class="wrapper">
...
<form name="destravarChar" id="destravarChar" method="post" action="functions/destravarchar.php">
	<fieldset>
		...
		<center>
		<input type="submit" name="destravarCharSubmit" id="destravarCharSubmit" class="formInput submit" value="Unlock Char" /></center>
	</fieldset>
</form></div>
</body>
